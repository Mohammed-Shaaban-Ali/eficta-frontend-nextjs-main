...
import PopularFacilities from '@/views/hotel-single/PopularFacilities';
import ModalVideo from 'react-modal-video';
import SidebarRight2 from '@/views/hotel-single/SidebarRight2';
import RatingBox from '@/views/hotel-single/RatingBox';
import PropertyHighlights2 from '@/views/hotel-single/PropertyHighlights2';

export default function GalleryTwo({ hotel }: any) {
