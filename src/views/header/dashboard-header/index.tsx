      ...
      >
        <div className="header__container px-30 sm:px-20">
          <div className="-left-side">
            <Link href="/" className="header-logo d-flex items-center mt-20">
              <Image
          ...
          <div className="row justify-between items-center dashboard-header-content">
            <div className="col-auto">
              <div className="d-flex items-center">
                ...
                <div className="single-field relative d-flex items-center md:d-none dashboard-search">
                  <input
                    className="dashboard-search-input border-light text-dark-1 h-50 rounded-8"
                    type="email"
                    placeholder="Search"
                  />
            ...
            <div className="col-auto">
              <div className="d-flex items-center">
                ...
                <div className="row items-center x-gap-5 y-gap-20 dashboard-actions lg:d-none">
                  <div className="col-auto">
                ...
                <div className="d-none xl:d-flex x-gap-20 items-center dashboard-mobile-menu">
                  <div>
                    <button
