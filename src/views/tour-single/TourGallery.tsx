...
import SidebarRight from '@/views/tour-single/SidebarRight';
import Overview from '@/views/tour-single/Overview';
import TourSnapShot from '@/views/tour-single/TourSnapShot';
import { Gallery, Item } from 'react-photoswipe-gallery';
import { Swiper, SwiperSlide } from 'swiper/react';
import { Navigation } from 'swiper/modules';
import ModalVideo from 'react-modal-video';

export default function TourGallery({ tour }: any) {
          ...
          <div className="row y-gap-30">
            <div className="col-xl-8">
              <div className="relative d-flex justify-center overflow-hidden js-section-slider">
                ...
                >
                  {tour?.slideImg?.map((slide: any, i: number) => (
                    <SwiperSlide key={i}>
                      <Image
                        width={451}
                        height={450}
