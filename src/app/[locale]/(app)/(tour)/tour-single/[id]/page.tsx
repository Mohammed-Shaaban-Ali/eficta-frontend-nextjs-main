...
import TopBreadCrumb from '@/views/tour-single/TopBreadCrumb';
import ReviewProgress2 from '@/views/tour-single/guest-reviews/ReviewProgress2';
import DetailsReview2 from '@/views/tour-single/guest-reviews/DetailsReview2';
import ReplyForm from '@/views/tour-single/ReplyForm';
import ReplyFormReview2 from '@/views/tour-single/ReplyFormReview2';
import CallToActions from '@/views/common/CallToActions';
import Footer from '@/components/layout/Footer';
import Tours from '@/views/tours/Tours';
import Faq from '@/views/faq/Faq';
import { Link } from '@/i18n/navigation';
import Itinerary from '@/views/tour-single/itinerary';
import ImportantInfo from '@/views/tour-single/ImportantInfo';
import TourGallery from '@/views/tour-single/TourGallery';

export const metadata = {
  title: 'Tour Single || Efica ',
  description: 'Efica ',
};

const TourSingleV1Dynamic = ({ params }: any) => {
  const id = params.id;
