import WhyChoose from '@/views/block/BlockGuide';
import Address from '@/views/block/Address';
import Social from '@/views/common/social/Social';
        ...
        <div className="row justify-end">
          <div className="col-xl-5 col-lg-7">
            <div className="map-form px-40 pt-40 pb-50 lg:px-30 lg:py-30 md:px-24 md:py-24 bg-white rounded-4 shadow-4">
              <div className="text-22 fw-500">{t('send_message')}</div>
              <ContactForm />
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row x-gap-80 y-gap-20 justify-between">
            <div className="col-12">
              <div className="text-30 sm:text-24 fw-600">{t('contact_us')}</div>
            </div>
          ...
          <div className="row justify-center text-center">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">{t('why_choose_us')}</h2>
