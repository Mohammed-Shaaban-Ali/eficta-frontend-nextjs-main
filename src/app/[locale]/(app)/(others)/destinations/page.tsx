...
import TopDestinations2 from '@/views/destinations/TopDestinations2';
import Faq from '@/views/faq/Faq';
import TestimonialLeftCol from '@/views/home/TestimonialLeftCol';
import Testimonial from '@/views/home/Testimonial';
import { Link } from '@/i18n/navigation';
import Slights from '@/views/block/Slights';
import Blog from '@/views/blog/Blog3';
import LocationTopBar from '@/views/common/LocationTopBar';
import Banner from '@/views/destinations/components/Banner';
import Categories from '@/views/destinations/components/Categories';
import IntroTown from '@/views/destinations/components/IntroTown';
import Weather from '@/views/destinations/components/Weather';
import GeneralInfo from '@/views/destinations/components/GeneralInfo';
import Cars from '@/views/cars/Cars';
import Tours from '@/views/tours/Tours';
import Activity from '@/views/activity/Activity';
import Rentals from '@/views/rentals/Rentals';
import Hotels from '@/views/hotels/Hotels2';

export const metadata = {
  title: 'Destinations || Efica ',
  description: 'Efica ',
};
