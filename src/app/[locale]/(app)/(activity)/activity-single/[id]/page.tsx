...
import Overview from '@/views/activity-single/Overview';
import TourSnapShot from '@/views/activity-single/TourSnapShot';
import TopBreadCrumb from '@/views/activity-single/TopBreadCrumb';
import SidebarRight from '@/views/activity-single/SidebarRight';
import ReviewProgress2 from '@/views/activity-single/guest-reviews/ReviewProgress2';
import DetailsReview2 from '@/views/activity-single/guest-reviews/DetailsReview2';
import ReplyForm from '@/views/activity-single/ReplyForm';
import ReplyFormReview2 from '@/views/activity-single/ReplyFormReview2';
import CallToActions from '@/views/common/CallToActions';
import Footer from '@/components/layout/Footer';
import Tours from '@/views/tours/Tours';
import Faq from '@/views/faq/Faq';
import { Link } from '@/i18n/navigation';
import ImportantInfo from '@/views/activity-single/ImportantInfo';
import SlideGallery from '@/views/activity-single/SlideGallery';
import MapPropertyFinder from '@/components/parts/MapPropertyFinder';

const TourSingleV1Dynamic = () => {
  const activity =
    ActivitiesData.find((item) => item.id == 5) || ActivitiesData[0];
                    ...
                    <div className="col-auto">
                      <div className="d-flex items-center">
                        ...
                        <div className="text-14 text-light-1 ml-10">
                          ...
                          {(activity as any)?.numberOffReviews} reviews
                        </div>
                      </div>
                    </div>
                    {/* End .col */}
