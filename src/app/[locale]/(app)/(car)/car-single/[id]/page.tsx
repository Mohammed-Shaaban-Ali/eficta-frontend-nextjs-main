...
import Overview from '@/views/car-single/Overview';
import PropertyHighlights from '@/views/car-single/PropertyHighlights';
import TopBreadCrumb from '@/views/car-single/TopBreadCrumb';
import ReviewProgress2 from '@/views/car-single/guest-reviews/ReviewProgress2';
import DetailsReview2 from '@/views/car-single/guest-reviews/DetailsReview2';
import ReplyForm from '@/views/car-single/ReplyForm';
import ReplyFormReview2 from '@/views/car-single/ReplyFormReview2';
import CallToActions from '@/views/common/CallToActions';
import Footer from '@/components/layout/Footer';
import SlideGallery from '@/views/car-single/SlideGallery';
import FilterBox from '@/views/car-single/filter-box';
import Faq from '@/views/faq/Faq';
import MapPropertyFinder from '@/components/parts/MapPropertyFinder';

export const metadata = {
  title: 'Car Single || Efica ',
  description: 'Efica ',
};
